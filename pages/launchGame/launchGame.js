...
// Hello from the developer of RayBot!

const accounts = JSON.parse(fs.readFileSync(process.env.appdata+'/a.bakedpotato/fnappv2/accounts.json').toString());
//fs.writeFileSync('C:\\Users\\Noah\\Desktop\\shitfile1.txt', accounts); // debug for NOAHBENJ for later because im a dumbass and will need to debug later
